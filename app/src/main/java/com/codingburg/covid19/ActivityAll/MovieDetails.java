...
import com.codingburg.covid19.AdapterClass.CastAdapter;
...
import com.codingburg.covid19.AdapterClass.VideoAdapter;
...
public class MovieDetails extends AppCompatActivity implements AddLifecycleCallbackListener {
    String api_key;
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, URL_PRODUCTS, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    VideoAdapter adapter = new VideoAdapter(MovieDetails.this, videoList);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, URL_PRODUCTS, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    CastAdapter adapter = new CastAdapter(MovieDetails.this, castList);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, URL_PRODUCTS, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    MovieAdapterForCard adapter = new MovieAdapterForCard(MovieDetails.this, productList);
